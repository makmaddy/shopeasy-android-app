...
global $conn;
	...
	// selectprod_name, prod_mp, prod_price, prod_rating from productdetails WHERE prod_id =  prod_id
 	...
 	$stmt = $conn->prepare("SELECT proddetail.prod_id,  proddetail.prod_name, proddetail.prod_mrp, proddetail.prod_price, proddetail.prod_rating, proddetail.prod_img_url  FROM trending trend, productdetails proddetail  WHERE trend.prod_id = proddetail.prod_id ORDER BY trend.priority ASC");
