...
global $conn;
	...
	$status =0;
	$totalPrice = 0;
	$msg ="faill to delete product from cart";
	$information = array(  'status' =>  "faill to delete product from cart", 
	   ...
	   /// yes userid exist
		...
		$rows=$stmt2->affected_rows;
			...
			if($rows>0){	
					 ...
					 $information  = array(  'status' =>  "Successfully Delete product from cart", 
							'totalprice' =>   $totalPrice  ) ;
